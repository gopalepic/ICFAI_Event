  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    ...
    >
      <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
        <li>
          <div  className="text-gray-500 transition hover:opacity-75 text-lg"> Developed by :</div>
        </li>

        <li> 
          <a href="https://www.linkedin.com/in/himanshu-gupta-813056254/" target='blank' className="text-gray-500 transition hover:opacity-75 text-base"> 
